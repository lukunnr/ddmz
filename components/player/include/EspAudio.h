 ...
 *
 * @param audoResume auto resume after tone finished or not, 0:disable, 1: enable, default.
 *
 * @return See AudioErr structure
 */
int EspAudioTonePlay(const char *uri, enum TerminationType type, int audoResume);
